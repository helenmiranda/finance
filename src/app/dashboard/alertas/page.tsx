...
export default async function AlertsPage() {
  ...
  return <DashboardShell active="alerts"><section className="content settings-content alerts-content">
    <header><div><p className="eyebrow">ACOMPANHAMENTO</p><h1>Alertas</h1><p className="muted">Avisos objetivos para agir antes de ultrapassar os limites.</p></div>{unread > 0 && <form action={markAllNotificationsRead}><button className="secondary-button" type="submit">Marcar todos como lidos</button></form>}</header>
